    ...
    <div className="fixed  bottom-0 left-0 right-0 flex flex-col max-w-4xl  mx-auto w-full">
      ...
      >
        ...
        <div className="flex items-center">
            ...
            className={`
              ...
              ${
                isRecording
                  ...
                  : "text-gray-500 hover:text-purple-600 hover:bg-gray-100 dark:hover:bg-gray-700"
              }
            `}
          ...
          {/* Settings button */}
          <button
            className="p-2 text-gray-500 hover:text-purple-600 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 mr-1"
